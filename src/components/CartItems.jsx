        ...
        <div className='py-10'>
            ...
            <div className='flex flex-col justify-between gap-y-16 mt-10 p-8 md:flex-row rounded-md w-full max-w-[777px]'>
                ...
                <div className='flex flex-col gap-10'>
                    ...
                    <div className='flexBetween pl-5 h-[3.3rem] bg-white ring-1 ring-slate-900/10 w-full max-w-[336px] rounded-xl'>
                        <input type="text" placeholder='Coupen Code...' className='bg-transparent border-none outline-none' />
