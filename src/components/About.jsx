    ...
    <section className='max-padd-container py-12 xl:py-32'>
      <div className='flex flex-col gap-16 xl:gap-8 xl:flex-row'>
        <div className='flex-1'>
          <h3 className='h3 capitalize'>Unveiling Our Product's key Feature</h3>
          <p className='py-5'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Corporis corrupti, ut consectetur dolore necessitatibus exercitationem.</p>
          <div className='flex flex-col items-start gap-y-4'>
            <div className='flexCenter gap-x-4'>
              ...
              <div>
                ...
                <p className=''>Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit recusandae, labore optio porro illo suscipit nihil!</p>
              </div>
            </div>
            <div className='flexCenter gap-x-4'>
              <div className='h-16 min-w-16 bg-secondary flexCenter rounded-md'>
